<template>
  <div class="spgl-list">
    ...
    <div class="spgl-list__search">
      <div>
        <span>商品搜索：</span>
        <el-input class="search__input" placeholder="请输入商品名称/商品标号..." prefix-icon="el-icon-search" v-model="searchVal">
        </el-input>
    ...
    <el-table ref="spglList" :data="tableData" @selection-change="handleSelectionChange" row-key="id" style="width: 100%">
      ...
      <el-table-column label="商品标编号" prop="id" align="center" width="110">
      </el-table-column>
      <el-table-column label="商品标题" prop="title" align="center" min-width="200">
      </el-table-column>
      <el-table-column label="排序" prop="order" align="center" width="80">
      </el-table-column>
      <el-table-column label="热门推荐" prop="hotRecommend" align="center" width="90">
      </el-table-column>
      <el-table-column label="购物车推荐" prop="carRecommend" align="center" width="120">
      </el-table-column>
      <el-table-column label="产地" prop="origin" align="center" min-width="140">
      </el-table-column>
      <el-table-column label="生产日期" prop="data" align="center" width="120">
      </el-table-column>
      <el-table-column label="规格" prop="format" align="center" width="80">
      </el-table-column>
      <el-table-column label="状态" prop="goodState" align="center" width="80">
      </el-table-column>
      ...
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-table :data="props.row.taste_stock" style="width: 280px">
            <el-table-column label="口味" prop='taste' align="center" width="100">
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.$get('/content/goods/get_goods', params).then(res => {
        if (res.message === 'ok') {
