<template>
  <div class="table-box">
    ...
    <el-table ref="multipleTable" stripe align='center' :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="evaluation_score" align='center' label="评价" width="50">
      ...
      <el-table-column prop='goods_name' label="商品名称" align='center' min-width="100">
      </el-table-column>
      <el-table-column prop='evaluation_info' align='center' label="内容" show-overflow-tooltip width="100">
      </el-table-column>
      <el-table-column prop='images' align='center' label="图片" width="150">
        <template slot-scope="scope">
          <div class="img-list">
            <el-image v-if="scope.row.images.split(',')[0]" style="width: 100px; height: 100px" :src="scope.row.images.split(',')[0]" :preview-src-list="scope.row.images.split(',')">
            </el-image>
      ...
      <el-table-column prop='user_name' align='center' label="评价人" width="150">
      </el-table-column>
      <el-table-column prop='order_id' align='center' show-overflow-tooltip label="订单编号" width="150">
      </el-table-column>
      <el-table-column prop='evaluate_time' label="评价时间" align='center' width="100">
      </el-table-column>
