<template>
  ...
  <div class='fltq-list'>
    <div class="ssxd-body">
      <el-table class="ssxd-table" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" stripe
       @selection-change="handleSelectionChange">
        ...
        <el-table-column align='center' show-overflow-tooltip label="提现流水号">
        ...
        <el-table-column label="支出类别" align='center'>
